    ...
    return <div className="h-screen flex justify-center bg-gray-100">
        <div className="h-full flex flex-col justify-center">
            <div className="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                <div className="flex flex-col space-1.5 p-6">
                    <h2 className="text-3xl fond-bold text-center">Send Money</h2>
                </div>
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            ...
                            }} type="number" className="flex h-10 w-full rounder-md border border-input bg-background px-3 py-2 text-sm" id="amount" placeholder="Enter Money" />
                        </div>
